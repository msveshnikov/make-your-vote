...
ssh -l ubuntu makeyour.vote "docker exec vote_mongodb_1 mongoexport --db vote --type csv --collection users --fields _id,email,name,isAdmin,preferences,createdAt,lastLogin >users.csv"
