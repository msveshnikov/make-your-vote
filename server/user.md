...
This file (`server/user.js`) handles all user-related API endpoints in the application, including
authentication, registration, password reset, and user profile management. It integrates with Google
OAuth for social login and includes email verification functionality.
